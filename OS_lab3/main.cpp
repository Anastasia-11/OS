...
void* threadMultiply2(void* pVoid);
void* threadMultiply3(void* pVoid);
...
void multiply2() {
    ...
    for (int i = 0; i < amountOfThreads; ++i) {
        ...
        pthread_create(&threads[i], nullptr, &threadMultiply2, (void*)(params));
...
void multiply3() {
    ...
    for (int i = 0; i < amountOfThreads; ++i) {
        ...
        pthread_create(&threads[i], nullptr, &threadMultiply3, (void*)(params));
        pthread_join(threads[i], nullptr);
    }
    delete[] threads;
}
